...
= Dynamic Access Control <ch:12_sets>
...
Previously, in @ch:11_equality, we saw how to write a simple
...
(described in @ch:11_equality:detached).
...
//
Unlike in our previous system (@ch:11_equality),
