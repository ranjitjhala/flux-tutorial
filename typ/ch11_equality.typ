...
= Simple Access Control <ch:11_equality>
...
== Reflection <ch:11_equality:reflection>
...
== Detached Specifications <ch:11_equality:detached>
...
best generated by a macro, as we will see shortly, in @ch:12_sets.]
...
== Refinement Level Functions <ch:11_equality:refinement-level-functions>
...
== Summary <ch:11_equality:summary>
...
`Role`.
//
Next, in @ch:12_sets, we will see how to extend our system with _set-valued_
