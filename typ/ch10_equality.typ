...
= Simple Access Control <ch:10_equality>
...
== Reflection <ch:10_equality:reflection>
...
== Defining Equality <ch:10_equality:equality>
...
best generated by a macro, as we will see shortly, in @ch:11_sets.]
...
`Role`.
//
Next, in @ch:11_sets, we will see how to extend our system with _set-valued_
