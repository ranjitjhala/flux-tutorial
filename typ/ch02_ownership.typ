...
#link("./01-refinements.typ")[Previously] and 
#link(<01-refinements>)[booger] and 
we saw how to refine basic Rust
...
In this chapter, lets see how Flux melds indexes and constraints 
...
we signed off with #link("./01-refinements.typ")[previously]
